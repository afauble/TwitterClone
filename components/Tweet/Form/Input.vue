    ...
    <div>
        ...
        <div class="flex items-center flex-shrink-0 p-4 pb-0">
            ...
            <div class="w-full p-2">
                <textarea v-model="text" class="w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text-white focus:ring-0" placeholder="What's happening?"></textarea>
            </div> 

        </div>

        <!-- File Selector & Selected image -->
        <div class="p-4 pl-16">
        ...
        <div class="flex p-2 pl-14">
            ...
            <div class="flex w-full text-white">
                <!-- Image Icon -->
                <div class="p-2 text-blue-400 rounded-full hover:bg-blue-50 dark:hover:bg-dim-800 cursor-pointer" @click="hanldeImageClick">
            ...
            <!-- Tweet btn -->
             <div class="ml-auto">
                <UIButton size="sm" class="font-bold" :disabled="isDisabled" @onClick="handleFormSubmit">Tweet</UIButton>
            </div>
